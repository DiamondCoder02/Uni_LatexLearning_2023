...
\usepackage{algorithm2e} % https://en.wikibooks.org/wiki/LaTeX/Algorithms

\usepackage{enumerate} % Meth or math
\usepackage{graphicx} % Insert images
\usepackage{geometry} 
\geometry{left=19mm, top=15mm, right=19mm} % Set the margins
...
\maketitle
    ...
    Path following is a relevant application problem within the Unmanned Aerial Vehicle (UAV) field. For instance, in 
    ...
    tight. These requirements are increasingly stringent when considering  Micro Aerial Vehicles (MAVs), where the sensor 
